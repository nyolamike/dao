        ...
        delete: [
          all_students: [
            students: %{
              "is_list" => true,
              "sql" =>
                "DELETE FROM `students`  WHERE (`students`.`student_id` = 5) AND `students`.`is_deleted` = 0"
            }
          ]
        ]
      ]
        ...
        delete: [
          all_students: [
            students: %{
              "is_list" => true,
              "sql" =>
                "DELETE FROM `students`  WHERE ((`students`.`name` = 'Tom') AND (`students`.`major` = 'undecided')) AND `students`.`is_deleted` = 0"
            }
          ]
        ]
      ]
