       ...
       [
         employee_mgr: [
           employee: %{
             "is_list" => false,
             "sql" =>
               "UPDATE `company_db.employees` SET branch_id = 1 WHERE (empl_id = 100) AND is_deleted = 0"
           }
         ]
       ]},
      {:add,
      ...
      update: [
        employee_mgr: [
          employees: %{
            ...
            "sql" => [
              "UPDATE `company_db.employees` SET branch_id = 1 WHERE (empl_id = 100) AND is_deleted = 0",
              "UPDATE `company_db.employees` SET branch_id = 2 WHERE (empl_id = 102) AND is_deleted = 0"
            ]
          }
        ]
      ],
