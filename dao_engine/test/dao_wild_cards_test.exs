    ...
    expected_cmd_results = [
      get: [
        llc_clients: [
          clients: %{
            "is_list" => true,
            "sql" => "SELECT * FROM `company_db.clients` WHERE (client_name LIKE '%LLC') AND is_deleted = 0"
          }
        ]
      ]
    ]
    ...
    expected_cmd_results = [
      get: [
        label_suppliers: [
          branch_supplier: %{
            "is_list" => false,
            "sql" => "SELECT * FROM `company_db.branch_suppliers` WHERE (supplier_name LIKE '% Label%') AND is_deleted = 0"
          }
        ]
      ]
    ]
    ...
    expected_cmd_results = [
      get: [
        oct_babies: [
          employee: %{
            "is_list" => false,
            "sql" => "SELECT * FROM `company_db.employees` WHERE (birth_date LIKE '____-10%') AND is_deleted = 0"
          }
        ]
      ]
    ]
    ...
    expected_cmd_results = [
      get: [
        school_clients: [
          client: %{
            "is_list" => false,
            "sql" => "SELECT * FROM `company_db.clients` WHERE (client_name LIKE '%school%') AND is_deleted = 0"
          }
        ]
      ]
    ]
